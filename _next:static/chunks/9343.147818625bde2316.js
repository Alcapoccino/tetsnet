...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[9343], {
    75740: function (e, t, r) {
        ...
        let s = Symbol()
            ...
            , p = (e, t, r, l) => {
                ...
                if (!a) {
                    let t = u(e);
                    a = Object.values(Object.getOwnPropertyDescriptors(t)).some(e => !e.configurable && !e.writable) ? [t, d(t)] : [t],
                        null == l || l.set(e, a)
                }
                let [c, f] = a
                    , g = r && r.get(c);
                return g && !!f === g[1].f || ((g = ((e, t) => {
                    let r = {
                        ...
                        , a = {
                            get: (t, s) => s === n ? e : (l("k", s),
                                p(Reflect.get(t, s), r.a, r.c, r.t)),
                            has: (t, n) => n === s ? (o = !0,
                                r.a.delete(e),
                                !0) : (l("h", n),
                                    Reflect.has(t, n)),
                            getOwnPropertyDescriptor: (e, t) => (l("o", t),
            ...
            , f = (e, t, r, s) => {
                ...
                try {
                    for (let r of n.h || [])
                        if (o = Reflect.has(e, r) !== Reflect.has(t, r))
                            return o;
                    if (!0 === n.w) {
                        if (o = ((e, t) => {
                        ...
                        for (let r of n.o || [])
                            if (o = !!Reflect.getOwnPropertyDescriptor(e, r) != !!Reflect.getOwnPropertyDescriptor(t, r))
                                return o;
                    for (let l of n.k || [])
                        if (o = f(e[l], t[l], r, s))
                            return o;
            ...
            , w = (e = Object.is, t = (e, t) => new Proxy(e, t), r = e => m(e) && !y.has(e) && (Array.isArray(e) || !(Symbol.iterator in e)) && !(e instanceof WeakMap) && !(e instanceof WeakSet) && !(e instanceof Error) && !(e instanceof Number) && !(e instanceof Date) && !(e instanceof String) && !(e instanceof RegExp) && !(e instanceof ArrayBuffer), s = e => {
                ...
                , n = new WeakMap, o = (e, t, r = s) => {
                    let l = n.get(e);
                    if ((null == l ? void 0 : l[0]) === t)
                        return l[1];
                    let a = Array.isArray(e) ? [] : Object.create(Object.getPrototypeOf(e));
                    return h(a, !0),
                        n.set(e, [t, a]),
                        Reflect.ownKeys(e).forEach(t => {
                            if (Object.getOwnPropertyDescriptor(a, t))
                                return;
                ...
                , l = new WeakMap, a = [1, 1], i = s => {
                    ...
                    let c = a[0]
                        ...
                        , C = Array.isArray(s) ? [] : Object.create(Object.getPrototypeOf(s))
                        , W = t(C, {
                            deleteProperty(e, t) {
                                let r = Reflect.get(e, t);
                                I(t);
                                let s = Reflect.deleteProperty(e, t);
                                return s && u(["delete", [t], r]),
                                    s
                            },
                            set(t, s, n, o) {
                                let a = Reflect.has(t, s)
                                    , c = Reflect.get(t, s, o);
                                if (a && (e(c, n) || l.has(n) && e(c, l.get(n))))
                                    return !0;
                                I(s),
                                    m(n) && (n = g(n) || n);
                                let d = n;
        ...
        let C = I({
            ...
            , W = {
                ...
                replace(e) {
                    C.history.length > 1 && (C.history[C.history.length - 1] = e,
                        C.view = e)
                },
                goBack() {
            ...
            , j = {
                ...
                formatNativeUrl(e, t, r) {
                    ...
                    let s = e;
                    s.includes("://") || (s = `${s = e.replaceAll("/", "").replaceAll(":", "")}://`),
                        s.endsWith("/") || (s = `${s}/`),
            ...
            , M = {
                ...
                setConfig(e) {
                    ...
                    L.initialize(),
                        ...
                        P.setIsCustomMobile(Boolean(null == (t = e.mobileWallets) ? void 0 : t.length)),
                        P.setIsCustomDesktop(Boolean(null == (r = e.desktopWallets) ? void 0 : r.length)),
        ...
        var U = Object.defineProperty
            ...
            , T = (e, t) => {
                for (var r in t || (t = {}))
                    R.call(t, r) && x(e, r, t[r]);
                if (S)
                    for (var r of S(t))
                        N.call(t, r) && x(e, r, t[r]);
                return e
            }
            ;
        ...
        async function K(e, t) {
            let r = T({
                ...
                , s = new URL(e, _);
            return s.searchParams.append("projectId", M.state.projectId),
        ...
        var z = Object.defineProperty
            ...
            , F = (e, t) => {
                for (var r in t || (t = {}))
                    H.call(t, r) && q(e, r, t[r]);
                if (B)
                    for (var r of B(t))
                        J.call(t, r) && q(e, r, t[r]);
                return e
            }
            ;
        let G = j.isMobile()
            ...
            , X = {
                ...
                async getRecomendedWallets() {
                    ...
                    if (j.isArray(e)) {
                        ...
                        let { chains: e, isAuth: r } = P.state
                            ...
                            , { listings: l } = G ? await V.getMobileListings(o) : await V.getDesktopListings(o);
                ...
                async getWallets(e) {
                    let t = F({}, e)
                        , { explorerRecommendedWalletIds: r, explorerExcludedWalletIds: s } = M.state
                        , { recomendedWallets: n } = Q;
                    if ("ALL" === s)
                        return Q.wallets;
                    n.length ? t.excludedIds = n.map(e => e.id).join(",") : j.isArray(r) && (t.excludedIds = r.join(",")),
                        j.isArray(s) && (t.excludedIds = [t.excludedIds, s].filter(Boolean).join(",")),
                        P.state.isAuth && (t.sdks = "auth_v1");
                    let { page: o, search: l } = e
                        , { listings: a, total: i } = G ? await V.getMobileListings(t) : await V.getDesktopListings(t)
                        , c = Object.values(a)
                        , d = l ? "search" : "wallets";
                    return Q[d] = {
            ...
            , Z = {
                ...
                open: async e => new Promise(t => {
                    ...
                    if (j.removeWalletConnectDeepLink(),
        ...
        var ee = Object.defineProperty
            ...
            , eo = (e, t) => {
                for (var r in t || (t = {}))
                    er.call(t, r) && en(e, r, t[r]);
                if (et)
                    for (var r of et(t))
                        es.call(t, r) && en(e, r, t[r]);
                return e
            }
            ;
        let el = I({
    ...
    59343: function (e, t, r) {
        ...
        class n {
            ...
            async initUi() {
                if ("u" > typeof window) {
                    await Promise.all([r.e(2592), r.e(1391)]).then(r.bind(r, 41391));
