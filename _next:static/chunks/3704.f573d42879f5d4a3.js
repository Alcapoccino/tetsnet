(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[3704], {
    ...
    1468: function (t, e, n) {
        ...
        let r = n(70655);
        r.__exportStar(n(40926), e),
            r.__exportStar(n(88618), e)
    },
        ...
        class u {
            ...
            onError(t, e) {
                let n = this.parseError(e)
                    ...
                    , o = (0,
                        a.formatJsonRpcError)(t, r);
                this.events.emit("payload", o)
            }
            parseError(t, e = this.url) {
                return (0,
                    a.parseConnectionError)(t, e, "HTTP")
            }
            resetMaxListeners() {
    ...
    54098: function (t, e) {
        var n, r = "undefined" != typeof self ? self : this, o = function () {
            function t() {
                this.fetch = !1,
                        ...
                        this._initBody = function (t) {
                            if (this._bodyInit = t,
                                ...
                                if ("string" == typeof t)
                                    ...
                                    var n;
                                    e.arrayBuffer && e.blob && (n = t) && DataView.prototype.isPrototypeOf(n) ? (this._bodyArrayBuffer = h(t.buffer),
                                        this._bodyInit = new Blob([this._bodyArrayBuffer])) : e.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(t) || o(t)) ? this._bodyArrayBuffer = h(t) : this._bodyText = t = Object.prototype.toString.call(t)
                                }
                            } else
                                this._bodyText = "";
